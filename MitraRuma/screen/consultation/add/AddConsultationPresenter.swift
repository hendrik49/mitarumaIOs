...
class AddConsultationPresenter {
    ...
    func book(detail: String, estimatedBudget: Int, name: String, contact: String, address: String) {
        let params: ParamsSubmitConsultationEntity = ParamsSubmitConsultationEntity(estimatedBudget: estimatedBudget, description: detail, city: "DKI Jakarta", street: address, zipcode: "14154", name: name, photos: photoList.map({ return ParamsFileUrl(pathUrl: $0.remoteUrl) }), contact: contact)
